...
g++ -m32 -shared edl_pywrapper.cpp -I%PYTHON_ROOT%\include -I%BOOST_ROOT% -L%PYTHON_ROOT%\libs -lpython37 -L. -LEDL -IEDL -ledl -L%BOOST_ROOT%\stage\lib -llibboost_python37-mgw82-mt-x32-1_69 -o edl_py.pyd BOOST_PYTHON_STATIC_LIB
